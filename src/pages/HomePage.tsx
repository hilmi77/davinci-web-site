  ...
  return (
    <>
      <Helmet>
        ...
        <title>Da Vinci Board Game Cafe | {i18n.language === 'tr' ? "Ankara'nın En Büyük Kutu Oyunu Kafesi" : "Ankara's Largest Board Game Cafe"}</title>
        ...
        <script type="application/ld+json">{JSON.stringify({
          ...
          "address": {
            "@type": "PostalAddress",
            "streetAddress": "Neorama İş Merkezi, Beştepe Mah. Yaşam Cd, Adalet Sokağı No:4/B",
          ...
          "openingHoursSpecification": [
            { "@type": "OpeningHoursSpecification", "dayOfWeek": ["Monday","Tuesday","Wednesday","Thursday","Friday"], "opens": "12:00", "closes": "00:00" },
