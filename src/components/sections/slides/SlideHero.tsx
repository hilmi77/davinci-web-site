      ...
      <div style={{
        ...
        <div className="container-xl" style={{ width: '100%', pointerEvents: 'auto', display: 'flex', alignItems: 'center', justifyContent: 'space-between', gap: '40px' }}>
          <div style={{ flex: '1 1 0', minWidth: 0 }}>
            <div style={{
              fontFamily: 'var(--font-display)', fontSize: 'clamp(2.8rem, 6.5vw, 5.5rem)',
              fontWeight: 900, lineHeight: 1.05, color: '#fff', letterSpacing: '-0.02em', marginBottom: '24px',
            }}>
            ...
            <motion.p
              ...
              style={{
                ...
                maxWidth: '500px', marginTop: '20px', marginBottom: '40px', lineHeight: 1.7,
              }}
            >
            ...
            >
              <motion.a
                ...
                style={{
                  ...
                  background: 'var(--red)', color: '#fff', padding: '16px 32px',
              ...
              <motion.a
                ...
                style={{
                  display: 'inline-flex', alignItems: 'center', gap: '8px',
                  background: 'rgba(255,255,255,0.08)', color: '#fff', padding: '16px 32px',
          ...
          {monthlyImageUrl && (
            ...
            >
              ...
              >
                <img src={monthlyImageUrl} alt="monthly activity" style={{ width: '460px', maxHeight: '600px', objectFit: 'contain', display: 'block' }} />
              </div>
            </motion.div>
          )}
        </div>
